...
_get_process_lifetime:     file format elf32-i386
...
int main(void)
{
   ...
   e:	83 ec 04             	sub    $0x4,%esp
    ...
    int pid = fork();
  11:	e8 f5 02 00 00       	call   30b <fork>
    if (pid < 0)
  16:	85 c0                	test   %eax,%eax
  18:	0f 88 82 00 00 00    	js     a0 <main+0xa0>
    {
        printf(1, "fork failed.\n");
    }
    else if (pid == 0)
  1e:	74 34                	je     54 <main+0x54>
        exit();
    }
    else
    {
        // Parent process
        wait();
  20:	e8 f6 02 00 00       	call   31b <wait>
        sleep(10);
  25:	83 ec 0c             	sub    $0xc,%esp
  28:	6a 0a                	push   $0xa
  2a:	e8 74 03 00 00       	call   3a3 <sleep>
        int t3 = get_process_lifetime(getpid());
  2f:	e8 5f 03 00 00       	call   393 <getpid>
  34:	89 04 24             	mov    %eax,(%esp)
  37:	e8 7f 03 00 00       	call   3bb <get_process_lifetime>
        printf(1, "parent process lifetime: %d\n", t3);
  3c:	83 c4 0c             	add    $0xc,%esp
  3f:	50                   	push   %eax
  40:	68 c6 07 00 00       	push   $0x7c6
  45:	6a 01                	push   $0x1
  47:	e8 44 04 00 00       	call   490 <printf>
  ...
  54:	e8 3a 03 00 00       	call   393 <getpid>
  59:	83 ec 0c             	sub    $0xc,%esp
  5c:	50                   	push   %eax
  5d:	e8 59 03 00 00       	call   3bb <get_process_lifetime>
        printf(1, "child process lifetime before sleep: %d\n", t2);
  62:	83 c4 0c             	add    $0xc,%esp
  65:	50                   	push   %eax
  66:	68 e4 07 00 00       	push   $0x7e4
  6b:	6a 01                	push   $0x1
  6d:	e8 1e 04 00 00       	call   490 <printf>
        sleep(10);
  72:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
  79:	e8 25 03 00 00       	call   3a3 <sleep>
        int t1 = get_process_lifetime(getpid());
  7e:	e8 10 03 00 00       	call   393 <getpid>
  83:	89 04 24             	mov    %eax,(%esp)
  86:	e8 30 03 00 00       	call   3bb <get_process_lifetime>
        printf(1, "child process lifetime after sleep: %d\n", t1);
  8b:	83 c4 0c             	add    $0xc,%esp
  8e:	50                   	push   %eax
  8f:	68 10 08 00 00       	push   $0x810
  94:	6a 01                	push   $0x1
  96:	e8 f5 03 00 00       	call   490 <printf>
        exit();
  9b:	e8 73 02 00 00       	call   313 <exit>
        printf(1, "fork failed.\n");
  a0:	50                   	push   %eax
  a1:	50                   	push   %eax
  a2:	68 b8 07 00 00       	push   $0x7b8
  a7:	6a 01                	push   $0x1
  a9:	e8 e2 03 00 00       	call   490 <printf>
  ae:	83 c4 10             	add    $0x10,%esp
  b1:	eb 9c                	jmp    4f <main+0x4f>
  b3:	66 90                	xchg   %ax,%ax
  b5:	66 90                	xchg   %ax,%ax
  b7:	66 90                	xchg   %ax,%ax
  b9:	66 90                	xchg   %ax,%ax
...
000003bb <get_process_lifetime>:
SYSCALL(get_process_lifetime)
 3bb:	b8 17 00 00 00       	mov    $0x17,%eax
 3c0:	cd 40                	int    $0x40
 3c2:	c3                   	ret    

000003c3 <digitalRoot>:
SYSCALL(digitalRoot)
 ...
 499:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 509:	ff 24 85 40 08 00 00 	jmp    *0x840(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 617:	90                   	nop
          s = "(null)";
 618:	ba 38 08 00 00       	mov    $0x838,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 631:	a1 40 0b 00 00       	mov    0xb40,%eax
{
 ...
 671:	5b                   	pop    %ebx
  freep = p;
 672:	89 15 40 0b 00 00    	mov    %edx,0xb40
}
 678:	5e                   	pop    %esi
 679:	5f                   	pop    %edi
 67a:	5d                   	pop    %ebp
 ...
 6a9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6ac:	89 15 40 0b 00 00    	mov    %edx,0xb40
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6c9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6cc:	8b 3d 40 0b 00 00    	mov    0xb40,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 70f:	73 4f                	jae    760 <malloc+0xa0>
    ...
    if(p == freep)
 711:	8b 3d 40 0b 00 00    	mov    0xb40,%edi
 ...
 73a:	e8 f1 fe ff ff       	call   630 <free>
  return freep;
 73f:	8b 15 40 0b 00 00    	mov    0xb40,%edx
 ...
 787:	0b 00 00 
    base.s.size = 0;
 78a:	bf 44 0b 00 00       	mov    $0xb44,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 799:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 79b:	c7 05 48 0b 00 00 00 	movl   $0x0,0xb48
 7a2:	00 00 00 
    if(p->s.size >= nunits){
