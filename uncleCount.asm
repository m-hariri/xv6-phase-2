...
_uncleCount:     file format elf32-i386
...
int main(int argc, char *argv[])
{
  ...
  11:	83 ec 08             	sub    $0x8,%esp
    int a=fork();
  14:	e8 32 03 00 00       	call   34b <fork>
  19:	89 c3                	mov    %eax,%ebx
    if(a<0){
  1b:	85 c0                	test   %eax,%eax
  1d:	78 09                	js     28 <main+0x28>
        while(wait()!=-1){}
    }
    else if(a==0){
  1f:	75 11                	jne    32 <main+0x32>
        while(1){}
  21:	eb fe                	jmp    21 <main+0x21>
  23:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  27:	90                   	nop
        while(wait()!=-1){}
  28:	e8 2e 03 00 00       	call   35b <wait>
  2d:	83 f8 ff             	cmp    $0xffffffff,%eax
  30:	75 f6                	jne    28 <main+0x28>
    }
    int b=fork();
  32:	e8 14 03 00 00       	call   34b <fork>
  37:	89 c6                	mov    %eax,%esi
    if(b<0){
  39:	85 c0                	test   %eax,%eax
  3b:	78 5a                	js     97 <main+0x97>
        while(wait()!=-1){}
    }
    else if(b==0){
  3d:	74 6e                	je     ad <main+0xad>
        while(1){}
    }
    int c=fork();
  3f:	e8 07 03 00 00       	call   34b <fork>
  44:	89 c7                	mov    %eax,%edi
    if(c<0){
  46:	85 c0                	test   %eax,%eax
  48:	78 65                	js     af <main+0xaf>
        while(wait()!=-1){}
    }
    else if(c==0){
  4a:	74 79                	je     c5 <main+0xc5>
        }
  ...
  4f:	6a 02                	push   $0x2
  51:	e8 8d 03 00 00       	call   3e3 <sleep>
    uncleCount(a);
  56:	89 1c 24             	mov    %ebx,(%esp)
  59:	e8 ad 03 00 00       	call   40b <uncleCount>
    sleep(2);
  5e:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
  65:	e8 79 03 00 00       	call   3e3 <sleep>
    uncleCount(b);
  6a:	89 34 24             	mov    %esi,(%esp)
  6d:	e8 99 03 00 00       	call   40b <uncleCount>
    sleep(2);
  72:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
  79:	e8 65 03 00 00       	call   3e3 <sleep>
    uncleCount(c);
  7e:	89 3c 24             	mov    %edi,(%esp)
  81:	e8 85 03 00 00       	call   40b <uncleCount>
    sleep(2);
  86:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
  8d:	e8 51 03 00 00       	call   3e3 <sleep>
    exit();
  92:	e8 bc 02 00 00       	call   353 <exit>
        while(wait()!=-1){}
  97:	e8 bf 02 00 00       	call   35b <wait>
  9c:	83 f8 ff             	cmp    $0xffffffff,%eax
  9f:	74 9e                	je     3f <main+0x3f>
  a1:	e8 b5 02 00 00       	call   35b <wait>
  a6:	83 f8 ff             	cmp    $0xffffffff,%eax
  a9:	75 ec                	jne    97 <main+0x97>
  ab:	eb 92                	jmp    3f <main+0x3f>
        while(1){}
  ad:	eb fe                	jmp    ad <main+0xad>
        while(wait()!=-1){}
  af:	e8 a7 02 00 00       	call   35b <wait>
  b4:	83 f8 ff             	cmp    $0xffffffff,%eax
  b7:	74 93                	je     4c <main+0x4c>
  b9:	e8 9d 02 00 00       	call   35b <wait>
  be:	83 f8 ff             	cmp    $0xffffffff,%eax
  c1:	75 ec                	jne    af <main+0xaf>
  c3:	eb 87                	jmp    4c <main+0x4c>
        int a_child=fork();
  c5:	e8 81 02 00 00       	call   34b <fork>
        if(a_child==0){
  ca:	85 c0                	test   %eax,%eax
  cc:	74 02                	je     d0 <main+0xd0>
        while(1){}
  ce:	eb fe                	jmp    ce <main+0xce>
            sleep(2);
  d0:	83 ec 0c             	sub    $0xc,%esp
  d3:	6a 02                	push   $0x2
  d5:	e8 09 03 00 00       	call   3e3 <sleep>
        uncleCount(getpid());
  da:	e8 f4 02 00 00       	call   3d3 <getpid>
  df:	89 04 24             	mov    %eax,(%esp)
  e2:	e8 24 03 00 00       	call   40b <uncleCount>
        sleep(2);
  e7:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
  ee:	e8 f0 02 00 00       	call   3e3 <sleep>
  f3:	83 c4 10             	add    $0x10,%esp
  f6:	eb d6                	jmp    ce <main+0xce>
  f8:	66 90                	xchg   %ax,%ax
  fa:	66 90                	xchg   %ax,%ax
  fc:	66 90                	xchg   %ax,%ax
  fe:	66 90                	xchg   %ax,%ax
...
000003fb <get_process_lifetime>:
SYSCALL(get_process_lifetime)
 3fb:	b8 17 00 00 00       	mov    $0x17,%eax
 400:	cd 40                	int    $0x40
 402:	c3                   	ret    

00000403 <digitalRoot>:
SYSCALL(digitalRoot)
...
free(void *ap)
{
 ...
 671:	a1 0c 0b 00 00       	mov    0xb0c,%eax
{
 ...
 6b1:	5b                   	pop    %ebx
  freep = p;
 6b2:	89 15 0c 0b 00 00    	mov    %edx,0xb0c
}
 6b8:	5e                   	pop    %esi
 6b9:	5f                   	pop    %edi
 6ba:	5d                   	pop    %ebp
 ...
 6e9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6ec:	89 15 0c 0b 00 00    	mov    %edx,0xb0c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 709:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 70c:	8b 3d 0c 0b 00 00    	mov    0xb0c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 74f:	73 4f                	jae    7a0 <malloc+0xa0>
    ...
    if(p == freep)
 751:	8b 3d 0c 0b 00 00    	mov    0xb0c,%edi
 ...
 77a:	e8 f1 fe ff ff       	call   670 <free>
  return freep;
 77f:	8b 15 0c 0b 00 00    	mov    0xb0c,%edx
 ...
 7ac:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7af:	89 15 0c 0b 00 00    	mov    %edx,0xb0c
}
