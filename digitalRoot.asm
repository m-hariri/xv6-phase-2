...
_digitalRoot:     file format elf32-i386
  ...
  11:	83 39 02             	cmpl   $0x2,(%ecx)
{
  ...
  44:	ff 70 04             	push   0x4(%eax)
  47:	e8 f4 01 00 00       	call   240 <atoi>
    digitalRoot(number);
  4c:	89 04 24             	mov    %eax,(%esp)
  4f:	e8 0f 03 00 00       	call   363 <digitalRoot>
    exit();
 ...
 439:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4a9:	ff 24 85 98 07 00 00 	jmp    *0x798(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5b7:	90                   	nop
          s = "(null)";
 5b8:	ba 8e 07 00 00       	mov    $0x78e,%edx
        while(*s != 0){
 ...
 5d1:	a1 98 0a 00 00       	mov    0xa98,%eax
{
 ...
 611:	5b                   	pop    %ebx
  freep = p;
 612:	89 15 98 0a 00 00    	mov    %edx,0xa98
}
 618:	5e                   	pop    %esi
 619:	5f                   	pop    %edi
 61a:	5d                   	pop    %ebp
 ...
 649:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 64c:	89 15 98 0a 00 00    	mov    %edx,0xa98
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 669:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 66c:	8b 3d 98 0a 00 00    	mov    0xa98,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6af:	73 4f                	jae    700 <malloc+0xa0>
    ...
    if(p == freep)
 6b1:	8b 3d 98 0a 00 00    	mov    0xa98,%edi
 ...
 6da:	e8 f1 fe ff ff       	call   5d0 <free>
  return freep;
 6df:	8b 15 98 0a 00 00    	mov    0xa98,%edx
 ...
 727:	0a 00 00 
    base.s.size = 0;
 72a:	bf 9c 0a 00 00       	mov    $0xa9c,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 739:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 73b:	c7 05 a0 0a 00 00 00 	movl   $0x0,0xaa0
 742:	00 00 00 
    if(p->s.size >= nunits){
