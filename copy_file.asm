...
_copy_file:     file format elf32-i386
  ...
  11:	83 39 03             	cmpl   $0x3,(%ecx)
{
  ...
  19:	50                   	push   %eax
  1a:	50                   	push   %eax
  1b:	68 68 07 00 00       	push   $0x768
  20:	6a 01                	push   $0x1
  22:	e8 19 04 00 00       	call   440 <printf>
        exit();
  27:	e8 97 02 00 00       	call   2c3 <exit>
  ...
  34:	e8 2a 03 00 00       	call   363 <copy_file>
    if (result == -1)
  39:	83 c4 10             	add    $0x10,%esp
  3c:	83 f8 ff             	cmp    $0xffffffff,%eax
  3f:	74 1c                	je     5d <main+0x5d>
  ...
  4a:	50                   	push   %eax
  4b:	50                   	push   %eax
  4c:	68 8f 07 00 00       	push   $0x78f
  51:	6a 01                	push   $0x1
  53:	e8 e8 03 00 00       	call   440 <printf>
  58:	83 c4 10             	add    $0x10,%esp
  5b:	eb e8                	jmp    45 <main+0x45>
        printf(1, "copy failed.\n");
  5d:	52                   	push   %edx
  5e:	52                   	push   %edx
  5f:	68 81 07 00 00       	push   $0x781
  64:	6a 01                	push   $0x1
  66:	e8 d5 03 00 00       	call   440 <printf>
  6b:	83 c4 10             	add    $0x10,%esp
  6e:	eb d5                	jmp    45 <main+0x45>
 ...
 39c:	89 d1                	mov    %edx,%ecx
{
 ...
 3c9:	0f b6 92 00 08 00 00 	movzbl 0x800(%edx),%edx
 ...
 449:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4b9:	ff 24 85 a8 07 00 00 	jmp    *0x7a8(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5c7:	90                   	nop
          s = "(null)";
 5c8:	ba a0 07 00 00       	mov    $0x7a0,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5e1:	a1 a8 0a 00 00       	mov    0xaa8,%eax
{
 ...
 621:	5b                   	pop    %ebx
  freep = p;
 622:	89 15 a8 0a 00 00    	mov    %edx,0xaa8
}
 628:	5e                   	pop    %esi
 629:	5f                   	pop    %edi
 62a:	5d                   	pop    %ebp
 ...
 659:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 65c:	89 15 a8 0a 00 00    	mov    %edx,0xaa8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 679:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 67c:	8b 3d a8 0a 00 00    	mov    0xaa8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6bf:	73 4f                	jae    710 <malloc+0xa0>
    ...
    if(p == freep)
 6c1:	8b 3d a8 0a 00 00    	mov    0xaa8,%edi
 ...
 6ea:	e8 f1 fe ff ff       	call   5e0 <free>
  return freep;
 6ef:	8b 15 a8 0a 00 00    	mov    0xaa8,%edx
 ...
 737:	0a 00 00 
    base.s.size = 0;
 73a:	bf ac 0a 00 00       	mov    $0xaac,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 749:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 74b:	c7 05 b0 0a 00 00 00 	movl   $0x0,0xab0
 752:	00 00 00 
    if(p->s.size >= nunits){
