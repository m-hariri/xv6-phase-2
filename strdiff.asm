  ...
  14:	83 39 03             	cmpl   $0x3,(%ecx)
{
  ...
  1e:	57                   	push   %edi
  1f:	57                   	push   %edi
  20:	68 68 08 00 00       	push   $0x868
  25:	6a 01                	push   $0x1
  27:	e8 14 05 00 00       	call   540 <printf>
        exit();
  2c:	e8 92 03 00 00       	call   3c3 <exit>
    }
    else
    {
  ...
  31:	56                   	push   %esi
  32:	56                   	push   %esi
  33:	68 86 08 00 00       	push   $0x886
  38:	6a 01                	push   $0x1
  3a:	e8 01 05 00 00       	call   540 <printf>
        exit();
  3f:	e8 7f 03 00 00       	call   3c3 <exit>
    }
  ...
  47:	8b 40 08             	mov    0x8(%eax),%eax
    ...
    {
        if (string1[i] == '\0')
  4a:	0f b6 17             	movzbl (%edi),%edx
    char *string2 = argv[2];
  4d:	89 45 d0             	mov    %eax,-0x30(%ebp)
    int i = 0;
  50:	31 c0                	xor    %eax,%eax
        if (string1[i] == '\0')
  52:	84 d2                	test   %dl,%dl
  54:	75 4f                	jne    a5 <main+0xa5>
  56:	e9 8b 00 00 00       	jmp    e6 <main+0xe6>
  5b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  5f:	90                   	nop
    return p > 0x40 && p < 0x5b ? p | 0x60 : p;
  60:	89 d3                	mov    %edx,%ebx
  62:	8d 72 bf             	lea    -0x41(%edx),%esi
  65:	83 cb 60             	or     $0x60,%ebx
  68:	88 5d d7             	mov    %bl,-0x29(%ebp)
  6b:	89 f3                	mov    %esi,%ebx
  6d:	0f b6 75 d7          	movzbl -0x29(%ebp),%esi
  71:	80 fb 1a             	cmp    $0x1a,%bl
  74:	89 cb                	mov    %ecx,%ebx
  76:	0f 42 d6             	cmovb  %esi,%edx
  79:	8d 71 bf             	lea    -0x41(%ecx),%esi
  7c:	83 cb 60             	or     $0x60,%ebx
  7f:	88 5d d7             	mov    %bl,-0x29(%ebp)
  82:	89 f3                	mov    %esi,%ebx
  84:	0f b6 75 d7          	movzbl -0x29(%ebp),%esi
  88:	80 fb 1a             	cmp    $0x1a,%bl
  8b:	0f 42 ce             	cmovb  %esi,%ecx
  ...
  96:	88 54 05 d9          	mov    %dl,-0x27(%ebp,%eax,1)

        i++;
  9a:	83 c0 01             	add    $0x1,%eax
        if (string1[i] == '\0')
  9d:	0f b6 14 07          	movzbl (%edi,%eax,1),%edx
  a1:	84 d2                	test   %dl,%dl
  a3:	74 41                	je     e6 <main+0xe6>
        if (string2[i] == '\0')
  a5:	8b 75 d0             	mov    -0x30(%ebp),%esi
  a8:	0f b6 0c 06          	movzbl (%esi,%eax,1),%ecx
  ac:	84 c9                	test   %cl,%cl
  ae:	75 b0                	jne    60 <main+0x60>
            while (string1[i] != '\0')
  b0:	80 3c 07 00          	cmpb   $0x0,(%edi,%eax,1)
  b4:	74 52                	je     108 <main+0x108>
  b6:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  bd:	8d 76 00             	lea    0x0(%esi),%esi
                result[i] = '0';
  c0:	c6 44 05 d9 30       	movb   $0x30,-0x27(%ebp,%eax,1)
                i ++;
  c5:	83 c0 01             	add    $0x1,%eax
            while (string1[i] != '\0')
  c8:	80 3c 07 00          	cmpb   $0x0,(%edi,%eax,1)
  cc:	75 f2                	jne    c0 <main+0xc0>
    }
    if (i > 15)
  ce:	83 f8 0f             	cmp    $0xf,%eax
  d1:	7e 35                	jle    108 <main+0x108>
    {
        printf(1, "Strings must contain up to 15 characters!\n");
  d3:	53                   	push   %ebx
  d4:	53                   	push   %ebx
  d5:	68 b4 08 00 00       	push   $0x8b4
  da:	6a 01                	push   $0x1
  dc:	e8 5f 04 00 00       	call   540 <printf>
        exit();
  e1:	e8 dd 02 00 00       	call   3c3 <exit>
            while (string2[i] != '\0')
  e6:	8b 7d d0             	mov    -0x30(%ebp),%edi
  e9:	80 3c 07 00          	cmpb   $0x0,(%edi,%eax,1)
  ed:	74 19                	je     108 <main+0x108>
  ef:	89 fa                	mov    %edi,%edx
  f1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
                result[i] = '1';
  f8:	c6 44 05 d9 31       	movb   $0x31,-0x27(%ebp,%eax,1)
                i ++;
  fd:	83 c0 01             	add    $0x1,%eax
            while (string2[i] != '\0')
 100:	80 3c 02 00          	cmpb   $0x0,(%edx,%eax,1)
 104:	75 f2                	jne    f8 <main+0xf8>
 106:	eb c6                	jmp    ce <main+0xce>
    }

    result[i] = '\n';
 108:	c6 44 05 d9 0a       	movb   $0xa,-0x27(%ebp,%eax,1)
    printf(1, "%s \n", result);
 10d:	50                   	push   %eax
 10e:	8d 45 d9             	lea    -0x27(%ebp),%eax
 111:	50                   	push   %eax
 112:	68 9e 08 00 00       	push   $0x89e
 117:	6a 01                	push   $0x1
 119:	e8 22 04 00 00       	call   540 <printf>
    int fd;
    fd = open("strdiff_result", O_CREATE | O_RDWR);
 11e:	5a                   	pop    %edx
 11f:	59                   	pop    %ecx
 120:	68 02 02 00 00       	push   $0x202
 125:	68 a3 08 00 00       	push   $0x8a3
 12a:	e8 d4 02 00 00       	call   403 <open>
 ...
 132:	89 c3                	mov    %eax,%ebx
    write(fd, &result, size);
 134:	8d 45 d9             	lea    -0x27(%ebp),%eax
 137:	6a 0f                	push   $0xf
 139:	50                   	push   %eax
 13a:	53                   	push   %ebx
 13b:	e8 a3 02 00 00       	call   3e3 <write>
    close(fd);
 140:	89 1c 24             	mov    %ebx,(%esp)
 143:	e8 a3 02 00 00       	call   3eb <close>
    exit();
 148:	e8 76 02 00 00       	call   3c3 <exit>
...
char tolower(char p){
 ...
 156:	5d                   	pop    %ebp
    return p > 0x40 && p < 0x5b ? p | 0x60 : p;
 157:	8d 48 bf             	lea    -0x41(%eax),%ecx
 15a:	89 c2                	mov    %eax,%edx
 15c:	83 ca 60             	or     $0x60,%edx
 15f:	80 f9 1a             	cmp    $0x1a,%cl
 162:	0f 42 c2             	cmovb  %edx,%eax
}
 165:	c3                   	ret    
 ...
 549:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5b9:	ff 24 85 e8 08 00 00 	jmp    *0x8e8(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 6c7:	90                   	nop
          s = "(null)";
 6c8:	ba df 08 00 00       	mov    $0x8df,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6e1:	a1 14 0c 00 00       	mov    0xc14,%eax
{
 ...
 721:	5b                   	pop    %ebx
  freep = p;
 722:	89 15 14 0c 00 00    	mov    %edx,0xc14
}
 728:	5e                   	pop    %esi
 729:	5f                   	pop    %edi
 72a:	5d                   	pop    %ebp
 ...
 759:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 75c:	89 15 14 0c 00 00    	mov    %edx,0xc14
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 779:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 77c:	8b 3d 14 0c 00 00    	mov    0xc14,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7bf:	73 4f                	jae    810 <malloc+0xa0>
    ...
    if(p == freep)
 7c1:	8b 3d 14 0c 00 00    	mov    0xc14,%edi
 ...
 7ea:	e8 f1 fe ff ff       	call   6e0 <free>
  return freep;
 7ef:	8b 15 14 0c 00 00    	mov    0xc14,%edx
 ...
 81c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 81f:	89 15 14 0c 00 00    	mov    %edx,0xc14
}
 ...
 82f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 830:	c7 05 14 0c 00 00 18 	movl   $0xc18,0xc14
 837:	0c 00 00 
    base.s.size = 0;
 83a:	bf 18 0c 00 00       	mov    $0xc18,%edi
    base.s.ptr = freep = prevp = &base;
 83f:	c7 05 18 0c 00 00 18 	movl   $0xc18,0xc18
 846:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 849:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 84b:	c7 05 1c 0c 00 00 00 	movl   $0x0,0xc1c
 852:	00 00 00 
    if(p->s.size >= nunits){
